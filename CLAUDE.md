# dckr - AI Assistant Instructions

**Package**: `@devtools/dckr`
**Version**: 0.1.0
**Type**: devtools package

## Package Overview

**Description**: Docker Stack Orchestrator - Multi-stack management and deployment

**Purpose**: Provide docker stack orchestrator - multi-stack management and deployment functionality for the pkgs ecosystem.
...
**Executables**:
- `.local/bin/dckr` - Main executable
- `.local/bin/dckr-ai` - Main executable
- `.local/bin/dckr-config` - Main executable
- `.local/bin/dckr-monolithic` - Main executable
- `.local/bin/dckr-stack` - Main executable
- `.local/bin/dckr.pre-migration.backup` - Main executable
...
1. **Test installation**: `stow dckr`
2. **Test functionality**: Run main commands and verify output
3. **Test uninstallation**: `stow -D dckr`
