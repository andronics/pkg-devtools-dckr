...
All notable changes to @devtools/dckr will be documented in this file.
...
- Declared external command requirements: curl, docker, docker-compose, jq
...
- Package naming now includes collection scope: `@devtools/dckr`
